/* $Id: lbfgsb.c 270 2008-08-13 01:13:32Z satoken $ */
/*
  Original sources are included in:
  http://www.ece.northwestern.edu/~ciyou/code/Lbfgsb.2.4.tar.gz

  This file is translated by f2c and some modifications are applied so that
  it is not depend on libf2c.
*/

/* routines.f -- translated by f2c (version 20020621).
...
/* dummy functions */
#if 0
static integer f_open(olist *x)
{
  return 0;
}
static integer s_wsfe(cilist *x)
{
  return 0;
}
static integer s_wsle(cilist *x) 
{
  return 0;
}
...
static integer e_wsle(void)
{
  return 0;
}
static integer do_fio(integer *x, char *y, ftnlen z)
{
  return 0;
}
static integer do_lio(integer *x, integer *y, char *z, ftnlen a)
{
  return 0;
}
#endif
static doublereal etime_(real *x)
{
  return 0.0;
}

static integer s_cmp(char *x, char *y, ftnlen x_len, ftnlen y_len)
{
  return strncmp(x, y, min(x_len, y_len));
}

static int s_copy(char *x, char *y, ftnlen x_len, ftnlen y_len)
{
  strncpy(x, y, min(x_len, y_len));
  return 0;
}

/* The following is translated by f2c */
...
static /* Subroutine */
int mainlb_(integer *, integer *, doublereal *, 
...
static /* Subroutine */
int daxpy_(integer *, doublereal *, doublereal *, 
	   integer *, doublereal *, integer *);
static /* Subroutine */
int dscal_(integer *, doublereal *, doublereal *, 
	   integer *);
static /* Subroutine */
int freev_(integer *, integer *, integer *, 
	   integer *, integer *, integer *, integer *, logical *, logical *, 
	   logical *, integer *, integer *);
static
int dcopy_(integer *, doublereal *, 
	   integer *, doublereal *, integer *);
static /* Subroutine */
int timer_(doublereal *);
static
int formk_(integer *, 
	   ...
	   integer *);
static /* Subroutine */
int formt_(integer *, doublereal *, doublereal *, 
...
int subsm_(integer 
	   *, integer *, integer *, integer *, doublereal *, doublereal *, 
	   ...
	   doublereal *, integer *, integer *);
static /* Subroutine */
int prn1lb_(integer *, integer *, doublereal *, 
...
int cauchy_(integer *, doublereal *, 
	    ...
	    integer *, doublereal *);
static /* Subroutine */
int cmprlb_(integer *, integer *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
...
int projgr_(integer *, doublereal *, doublereal *,
	    integer *, doublereal *, doublereal *, doublereal *);
static /* Subroutine */
int bmv_(integer *, doublereal *, doublereal *, 
	 integer *, doublereal *, doublereal *, integer *);
static /* Subroutine */
int dcopy_(integer *, doublereal *, integer *, 
	   doublereal *, integer *);
static /* Subroutine */
int hpsolb_(integer *, doublereal *, integer *, 
	    integer *);
static /* Subroutine */
int dpofa_(doublereal *, integer *, integer *, 
	   integer *);
static /* Subroutine */
int dcsrch_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, char *, integer *, doublereal *, 
	    ftnlen);
static /* Subroutine */
int dcstep_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
